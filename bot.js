...
if (!reason) return message.reply('You must provide a ban reason!'); // Check if a reason has been given by the message author
if (!message.guild.member(user).bannable) return message.reply('I can\'t ban that user!'); // Check if the user is bannable with the bot's permissions
​
...
​
​
const modlogChannelID = '638716078834319370'; // Discord channel ID where you want to have logged the details about the ban
